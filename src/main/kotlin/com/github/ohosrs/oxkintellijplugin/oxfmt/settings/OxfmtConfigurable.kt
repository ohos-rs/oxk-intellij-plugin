            ...
            buttonsGroup {
                row {
                    disabledConfiguration = radioButton(
                        OxfmtBundle.message("oxfmt.settings.mode.disabled",
                            displayName)).bindSelected(
                        ConfigurationModeProperty(settings, ConfigurationMode.DISABLED)).component
                }
                row {
                    automaticConfiguration = radioButton(OxfmtBundle.message(
                        "oxfmt.settings.mode.automatic",
                        displayName)).bindSelected(
                        ConfigurationModeProperty(settings, ConfigurationMode.AUTOMATIC)).component

                    val detectAutomaticallyHelpText = OxfmtBundle.message(
                        "oxfmt.settings.mode.automatic.help",
                ...
                row {
                    manualConfiguration = radioButton(OxfmtBundle.message(
                        "oxfmt.settings.mode.manual",
                        displayName)).bindSelected(
