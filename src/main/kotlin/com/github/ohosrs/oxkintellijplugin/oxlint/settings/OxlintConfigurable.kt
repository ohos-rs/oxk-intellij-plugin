package com.github.ohosrs.oxkintellijplugin.oxlint.settings
...
import com.github.ohosrs.oxkintellijplugin.oxlint.OxlintRunTrigger
import com.github.ohosrs.oxkintellijplugin.oxlint.OxlintUnusedDisableDirectivesSeverity
import com.github.ohosrs.oxkintellijplugin.oxlint.services.OxlintServerService
...
private const val HELP_TOPIC = "reference.settings.oxk"
...
class OxlintConfigurable(private val project: Project) :
            ...
            buttonsGroup {
                row {
                    disabledConfiguration =
                        radioButton(OxlintBundle.message("oxlint.settings.mode.disabled",
                            displayName)).bindSelected(ConfigurationModeProperty(settings,
                            ConfigurationMode.DISABLED)).component
                }
                row {
                    automaticConfiguration =
                        radioButton(OxlintBundle.message("oxlint.settings.mode.automatic",
                            displayName)).bindSelected(ConfigurationModeProperty(settings,
                            ConfigurationMode.AUTOMATIC)).component

                    val detectAutomaticallyHelpText =
                        OxlintBundle.message("oxlint.settings.mode.automatic.help",
                ...
                row {
                    manualConfiguration =
                        radioButton(OxlintBundle.message("oxlint.settings.mode.manual",
                            displayName)).bindSelected(ConfigurationModeProperty(settings,
    ...
    companion object {
        const val CONFIGURABLE_ID = "com.github.ohosrs.oxkintellijplugin.settings.OxkSettingsConfigurable"
    }
}
