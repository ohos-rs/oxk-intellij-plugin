package com.github.ohosrs.oxkintellijplugin.oxlint.actions

import com.github.ohosrs.oxkintellijplugin.NOTIFICATION_GROUP
import com.github.ohosrs.oxkintellijplugin.OxkIcons
...
class OxlintFixAllAction : AnAction(), DumbAware {
    init {
        templatePresentation.icon = OxkIcons.OxkRound
    }
