...
import com.github.ohosrs.oxkintellijplugin.oxlint.settings.OxlintSettingsState.Companion.DEFAULT_EXTENSION_LIST
...
@State(name = "OxkSettings", storages = [Storage("OxkSettings.xml")],
